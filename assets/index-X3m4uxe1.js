...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(e,t,n){let r=new Float32Array(Ya),i=new q(0,1,0);return new Ei({name:`SphericalGaussianBlur`,defines:{n:Ya,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:po(),fragmentShader:`
	...
	`}var mo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new di(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=dr.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=dr.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=dr.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=dr.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case _:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=_;break;case v:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=v;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case _:case v:e.colorSpace=Le,e.minFilter=c,e.magFilter=c,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Sl=class extends xl{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},Cl=document.querySelector(`#app`),wl=new Qc({antialias:!0});wl.setPixelRatio(window.devicePixelRatio),wl.setSize(window.innerWidth,window.innerHeight),wl.shadowMap.enabled=!0,wl.shadowMap.type=2,Cl.appendChild(wl.domElement);var Tl=new jn,El=new io(wl);new Sl().load(`/suburban_garden_2k.hdr`,e=>{let t=El.fromEquirectangular(e).texture;Tl.environment=t,Tl.background=t,e.dispose(),El.dispose()});var Dl=new da(60,window.innerWidth/window.innerHeight,.1,100);Dl.position.set(2.5,2,3.5);var Ol=new cl(Dl,wl.domElement);Ol.enableDamping=!0,Ol.target.set(0,1.5,0);var kl=new _i(.7,.25,220,32),Al=new Oi({color:11156479,metalness:1,roughness:.15}),jl=new $r(kl,Al);jl.position.y=1.5,jl.castShadow=!0,Tl.add(jl);var Ml=new $r(new gi(20,20),new Oi({color:2763830,roughness:.9}));Ml.rotation.x=-Math.PI/2,Ml.receiveShadow=!0,Tl.add(Ml),Tl.add(new ha(16777215,.6));var Nl=new ma(16777215,1.2);Nl.position.set(5,5,5),Nl.castShadow=!0,Nl.shadow.mapSize.set(2048,2048),Nl.shadow.camera.near=1,Nl.shadow.camera.far=20,Nl.shadow.camera.left=-5,Nl.shadow.camera.right=5,Nl.shadow.camera.top=5,Nl.shadow.camera.bottom=-5,Tl.add(Nl);var Pl=new ma(8956671,.5);Pl.position.set(-5,-2,-3),Tl.add(Pl);function Fl(e,t,n){let r=document.querySelector(`#${e}`),i=document.querySelector(`#${e}-value`),a=()=>{n(Number(r.value)),i.textContent=Number(r.value).toFixed(2)};r.value=t,r.addEventListener(`input`,a),a()}Fl(`metalness`,Al.metalness,e=>Al.metalness=e),Fl(`roughness`,Al.roughness,e=>Al.roughness=e);var Il=document.querySelector(`#color`);Il.value=`#`+Al.color.getHexString(),Il.addEventListener(`input`,()=>Al.color.set(Il.value)),window.addEventListener(`resize`,()=>{Dl.aspect=window.innerWidth/window.innerHeight,Dl.updateProjectionMatrix(),wl.setSize(window.innerWidth,window.innerHeight)}),wl.setAnimationLoop(()=>{jl.rotation.x+=.005,jl.rotation.y+=.01,Ol.update(),wl.render(Tl,Dl)});